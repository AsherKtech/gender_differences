...
fwd_perf_df = pd.read_csv(here("data/processed/forward_stability_country_and_round_performance_indicators.csv"))
fwd_perf_df
bwd_perf_df = pd.read_csv(here("data/processed/backward_stability_country_and_round_performance_indicators.csv"))
bwd_perf_df
...
create_unified_countries_plot6(
    fwd_perf_df, 
    output_html=here("plots/forward_stability_countries_gender_similarity_trends_nw_europe.html"), 
...
create_unified_countries_plot6(
    fwd_perf_df, 
    output_html=here("plots/forward_stability_countries_gender_similarity_trends_other.html"),  
...
create_unified_countries_plot6(
    bwd_perf_df, 
    output_html=here("plots/backward_stability_countries_gender_similarity_trends_nw_europe.html"), 
    country_map=nw_europe_map
)
...
create_unified_countries_plot6(
    bwd_perf_df, 
    output_html=here("plots/backward_stability_countries_gender_similarity_trends_other.html"),  
    country_map=other_countries_map
)
# %%
