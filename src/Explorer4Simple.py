...
fig_trend.write_html("gender_similarity_trends_indicators.html", include_plotlyjs='cdn')
...
fig_imp.write_html("total_feature_importance_indicators.html", include_plotlyjs='cdn')
